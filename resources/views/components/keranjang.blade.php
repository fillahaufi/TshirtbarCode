<button class="uk-button uk-button-primary px-5" style="bottom: 0; right: 0; position: fixed; z-index: 300" href="#modal-overflow" uk-toggle>
    ...
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-footer d-flex flex-row">
            ...
            <div class="uk-text-right" style="width: fit-content; margin-left: auto">
                ...
                <a href="{{ url('/checkout') }}">
                    <button class="uk-button uk-button-primary" type="button">Checkout</button>
                </a>
            </div>
        </div>
