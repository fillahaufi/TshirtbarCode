        ...
        <div class="mx-5">
            <table class="uk-table uk-table-justify uk-table-divider">
                ...
                <tbody>
                    <tr>
                        <td>12/02/2021</td>
                        <td><img style="width: 100px" src="https://images.unsplash.com/photo-1527719327859-c6ce80353573?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dHNoaXJ0fGVufDB8MXwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt=""></td>
                        <td>Produk_Laki_1</td>
                        <td><button class="uk-button uk-button-default mx-auto d-flex" type="button" href="#modal-full" uk-toggle>Review</button></td>
                        <td><div class="card card-warning text-center text-white fw-bold">Pesanan sedang dikirim</div></td>
                    </tr>
                    <tr>
                        <td>22/01/2021</td>
                        <td><img style="width: 100px" src="https://c4.wallpaperflare.com/wallpaper/297/678/332/lionel-messi-soccer-photoshop-effects-wallpaper-preview.jpg" alt=""></td>
                        ...
                        <td><div class="card card-success text-center text-white fw-bold">Pesanan selesai</div></td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="uk-modal-dialog">
                ...
                <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                    ...
                    <div class="uk-padding-large d-flex flex-column">
                        ...
                        <button href="#" class=" uk-button uk-button-secondary mt-5" style="float: right">Submit Review</button>
                    </div>
                </div>
            </div>
        </div>
